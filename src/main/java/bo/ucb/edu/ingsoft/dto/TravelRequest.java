...
public class TravelRequest {
    ...
    private Integer addressStartTravelId;
    private Integer addressDeliveryTravelId;
    ...
    public Integer getAddressStartTravelId() {
        return addressStartTravelId;
    }

    public void setAddressStartTravelId(Integer addressStartTravelId) {
        this.addressStartTravelId = addressStartTravelId;
    }

    public Integer getAddressDeliveryTravelId() {
        return addressDeliveryTravelId;
    }

    public void setAddressDeliveryTravelId(Integer addressDeliveryTravelId) {
        this.addressDeliveryTravelId = addressDeliveryTravelId;
    }
